...
public class Vuelo {
    ...
    public void duracionVuelo() {
        try {
            ...
            System.out.println("Duracion del vuelo: " + duracion + " horas.");
        } catch (Exception e) {
            System.out.println("Error al calcular la duracion del vuelo: " + e.getMessage());
        }
    }
    ...
    public void agregarpasajero(Pasajeros pasajero) {
        if (avion != null) {
            ...
            System.out.println("No se puede agregar pasajero, no hay avion asignado al vuelo.");
        }
    }

    public void mostrar() {
        System.out.println("Numero de vuelo: " + numero_vuelo);
