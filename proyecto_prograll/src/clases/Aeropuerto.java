...
public class Aeropuerto {
    ...
    public void leer() {
        ...
        nombre = sc.nextLine();
        System.out.println("Ingrese la ciudad y país del aeropuerto:");
    ...
    public void duracionVuelo(int vuelo) {
        if (vuelo > 0 && vuelo <= numero_vuelos) {
            System.out.println("Duración del vuelo " + vuelo + ": " + vuelos[vuelo - 1].duracion + " horas.");
        } else {
            System.out.println("Número de vuelo inválido.");
        }
    }
    ...
    public void mostrar() {
        ...
        System.out.println("Ciudad y país: " + ciudad_pais);
        System.out.println("Número de pistas: " + numero_pistas);
        System.out.println("Número de vuelos: " + numero_vuelos);
        for (int i = 0; i < numero_pistas; i++) {
